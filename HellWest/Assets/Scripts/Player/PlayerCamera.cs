...
public class PlayerCamera : MonoBehaviour
{
    ...
    [Header("State")]
    [SerializeField] private CameraState _currentState = CameraState.FPS;
    ...
    {
        CameraState oldState = _currentState;
        switch (oldState)
        {
        ...
        switch (toState)
        {
            case CameraState.None:
                break;
            case CameraState.FPS:
                Player.Instance.Character.MeshRoot.gameObject.SetActive(false);
                _fpsArms.gameObject.SetActive(true);
                break;
            case CameraState.Detached:
                Player.Instance.Character.MeshRoot.gameObject.SetActive(true);
                _fpsArms.gameObject.SetActive(false);
                break;
            default:
                break;
        }
