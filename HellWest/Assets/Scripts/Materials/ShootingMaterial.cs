    ...
    private void InitializeStats(MaterialType type)
    {
        switch (type)
        {
            ...
            case MaterialType.ThinWood:
                Stats = new MaterialStats(10f, new Vector2(.15f, .85f));
                break;
            case MaterialType.ThickWood:
                Stats = new MaterialStats(45f, new Vector2(.15f, .85f));
                break;
            ...
            case MaterialType.ThinMetal:
                Stats = new MaterialStats(30f, new Vector2(.08f, .95f));
                break;
            case MaterialType.ThickMetal:
                Stats = new MaterialStats(70f, new Vector2(.08f, .95f));
                break;
